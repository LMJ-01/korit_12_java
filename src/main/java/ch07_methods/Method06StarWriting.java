...
public class Method06StarWriting {
    ...
    // 어떤 유형의 별찍기 할건지 main에서 받을 예정이기 떄문에.
    // method 정의 영역
        ...
        if (option < 1 || option > 4) {
            ...
            if(option == 1) {
                ...
                for (int i = 0; i < row + 1; i++) { // 여기 한계값이 i < row+1입니다.
                    // 별을 책임지는 안쪽 for문
                    for (int j = 0; j < i; j++) {   // i = 0, j = 0 일떄 별이 안찍혀서
                        result += "*";
                    }
                    result += "\n";
                }
    ...
    public static void main(String[] args) {
        ...
        int choice = 0;     // 증가하는 별인지 감소한느 별인지 etc
        ...
        /*
            이상의 89 라인에 함축되어있는 의미를 파악할 필요가 있습니다.
            1. getStar()라고 하는 정적 메서드가 있다는 점('정적'의 의민느 추후 학습)
            2. getStar() 메서드는 매개변수가 있고, return 타입이 있는 call4() 유형이라는 점.
                - () 내의 변수명이 들어가있다는 점에서, 그리고 그 변수의 자료형까지 고려하면
