...
/*
    ...
    일반 for 문 과의 차이점 :
        ...
        이를 이용하여 배열 내의 element에 for 문 내부에서 만 사용하는 변수에
...
//        System.out.println(number);   오류 발생
        /*
            첫 번쨰 반복에서 nums의 첫 번쨰 element인 1을 number에 대입 -> 초기화되었겠네요.
            즉 number = 1;이 된 상황입니다. 어디서 되었냐면 -> 37번 라인에서 적용되었습니다.
            그리고 38 번 라인에서 출력시키는 명령문 있으니까 "1"가 출력되겠네요.
            두 번째 반복으로 넘어가서 nums의 1번지에 있는 2가 number에 재대입됩니다.
            ...
            마지막 199번지에 있는 200이 number에 재대입되고 출력됩니다.
