...
/*
    ...
    주소값이 튀어나온다는 사실을 확인 할 수 있었습니다.

    근데 element의 값을 조정하거나, 더하거나 등의 추가적인 가공을 하기 위해서
    for문을 사용해왔는데, 굳이 변형이 없고 배열 자체에 값이 들억갔는지만
...
//        System.out.println(Arrays.asList(numbers).toString());
        ...
        // 메서드 정의할 떄 무언가 하나 더 쓰고 메서드를 정의했었습니다(추후 수업 예정)
        // chaing method로 toString()이 있음을 확인
