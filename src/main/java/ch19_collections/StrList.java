...
public class StrList {
    public static void main(String[] args) {
        ...
        strList.add("C#");
        strList.add("C++");
        // 순서가 보장되어 있기 때문에 집어넣는 순서대로 값이 들어갑니다.
        // 그리고 최초에 List의 방의 개수를 정하지 않았죠. 알아서 방이 늘어납니다.

        // Array와의 차이점 # 3 - 출력 방식
        // strArray를 출력만 하시오.
        System.out.println(Arrays.toString(strArray));
        // [김영, null, null, null, 김사]
        // List의 출력
        ...
        String removeElm1 = "JavaScript";
        boolean isRemoved = strList.remove(removeElm1);
        System.out.println(removeElm1 + " 삭제 여부 : " + isRemoved);
        System.out.println(strList);
        // [Java, python, C#, C++]
        ...
        for (String array : strArray) {
            System.out.print(array + " 학생 - ");
        }
        System.out.println();

        // list는 index 추출할 떄 리스트명.size() 를 씁니다. .length 아니고 method인 점 주의
        ...
        System.out.println();
        /*
            이상의 경우에는 배열일 떄는 구경도 못하는 향상된 for문의 장점이 있는데,
            내부의 index 지정을 .length를 쓰는지 .size()를 쓰는지 등을 고려하지 않아도
            된다는 점과, 출력할 때 [] 인덱스 넘버를 사용해야하는지 .get()을 사용해야하느지
