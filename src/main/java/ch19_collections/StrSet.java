...
/*
    ...
    List -> Set 혹은 Set -> List 로 형변환이 중요합니다.
...
//        }
        // 어쩄든 중복 제거를 strSet에서 햇기 떄문에 중복 제거 버전을 다시 list로 옮길 수 있을겁니다.
        List<String> modifiedList = new ArrayList<>();
        modifiedList.addAll(strSet);
        System.out.println(modifiedList);   // [Java, python, SpringBoot]
        Collections.sort(modifiedList);
        System.out.println(modifiedList);   // [Java, SpringBoot, python]
    }
}
