...
public class StrMap {
    public static void main(String[] args) {
        ...
        // {kor2026004=김사, kor2026005=김오, kor2026002=김이, kor2026003=김삼, kor2026001=김일}
        // 같은 key에 value를 입력하게 될 경우
        strMap1.put("kor2026005", "kimFive");
        System.out.println(strMap1);
        // {kor2026004=김사, kor2026005=kimFive, kor2026002=김이, kor2026003=김삼, kor2026001=김일}
        // key 하나 당 value는 하나이기 때문에 같은 key 지정하고 value를 입력한다면
        ...
        // {김이=100.0, 김오=4.5, 김일=98.2, 김삼=22.2, 김사=67.45}
        /*
...
//        List<Map.Entry<String, String>> entryList1 = strMap1.
        ...
        // [kor2026004, kor2026005, kor2026002, kor2026003, kor2026001]
...
//        Set<String> valueSet = strMap1.values();    // .values()가 있는거 보니까
        /*
            ...
            그리고 제가 여러분에게 요구하는 수준은 .values()를 봣을 떄 Collection이라는 자료형이
        ...
        /*
            Collection는 .sort()할 떄 써봤지만 Collection은 처음 써봤습니다.
