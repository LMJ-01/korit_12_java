    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (menu == 1) {
                ...
                if (book.containsKey(newBook)) {
                    System.out.println("이미 재고에 있는 도서입니다.");
                } else {
                    System.out.print("재고 수량을 입력하세요 >>> ");
                    int newbooknum = scanner.nextInt();
                    scanner.nextLine();
                    book.put(newBook, newbooknum);
                    System.out.println( newBook + " 도서가 " + newbooknum + " 권 추가되었습니다.");
                }
            } else if (menu == 2) {
                ...
                if (book.containsKey(BookName)) {
                    ...
                    scanner.nextLine();
                    book.replace(BookName, booknum);
                    System.out.println(BookName + " 도서가 " + booknum + " 으로 변경되었습니다.");
                } else {
                ...
                for (String key : book.keySet()) {
                    System.out.println("도서명 : " + key + ", 재고 수량 : " + book.get(key));
                }
            } else if (menu == 4) {
