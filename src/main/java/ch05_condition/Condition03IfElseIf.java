...
public class Condition03IfElseIf {
    ...
    public static void main(String[] args) {
        ...
        final int GOLD_POINT = 80;  // 즉, 변환없는 데이터를 사용하고 싶을 떄
...
//        }
        ...
        // 근데 보니까 좀 귀찮은 부분이 있습니다. 회원 등급에 그때그떄 sout으로
        // 써줘야 한다는 점이요.
        // 풀이법 # 2
        String userGrade = "";
        if (point > VIP_POINT) {
        ...
        /*
            ...
            풀이법 # 2의 경우엔느 반복되는 print문이 없어도 된다는 점에서
            장점을 가지고 있지만 20 점 이하인 경우에도 59번 라인이 실행되고,
            20 점 이하의 경우 userGrade가 ""에서 변화되지 않기 떄문에
            결과값이
            회원 등급 :
