...
//        animalData3.showData();   // 오류 발생
        /*
            ...
            시키는 부분 떄문이겠네요. Car를 Animal로 형변환시킬 수 있는 근거가 없는
            상태니까요.
         */
...
//        animalData6.showData();
        System.out.println(animalData4);    // AnimalData(animal=ch18_generic.wildcard.Human@372f7a8d)
        ...
        if (animalData100 == null) {
            System.out.println("내부의 값이 없습니다.");
        } else {
            System.out.println("객체는 생성됐는데 field에 값이 없습니다.");
        }

        System.out.println(animalData100.getAnimal());  // null
