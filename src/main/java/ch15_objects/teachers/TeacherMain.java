...
public class TeacherMain {
    public static void main(String[] args) {
        ...
        // 여러분들은 어느 수준까지는 그냥 작성할지, 아니면 너무 기니까 어느 부분을 잘라서
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            System.out.println("패키지명 + 클래스 명 출력 : " + fields[i].getType());
        ...
        /*
            ...
            ch15_objects.teacher.Teacher가 아니기 때문에 동일한 값 이 들어가 있다고 하더라도
