...
public class CalculatorMain {
    ...
    public static void main(String[] args) {
        /*
            ...
            // 그리고 여기의 정적 메서드에서는 두 개의 매개변수로 뭐할지 안정해져있습니다.
         */
        ...
        // Calculator 인터페이스의 객체명이 add이고, 내부 메서드는 compute()추상 메서드를 구현함 x + y로
        ...
        /*
            ...
            추상 메서드를 구현한 어떤 버전을 일반 표현식으로 썼든 람다식으로 썼든 람다식으로 썼든 다 해석해서
