...
public class PersonMain {
    public static void main(String[] args) {
        ...
        // 여기서 getter만을 사용하여
        // 김일일 학생의 나이는 0 살이고 주소는 서울특별시 종로구입니다. 라고 출려하도록 작성하시오.
        System.out.println(person1.getName() + " 학생의 나이는 "
            + person1.getAge() + " 살이고 주소는 " + person1.getAddress() +"입니다.");
        ...
        /*
            ...
            2. 4 글자 초과라면 "변경할 수 없습니다."를 출력한 후에 기존 이름을 그래도 사용할 것.
            3. 4 글자 이하라면 "이름이 변경되었습니다."
                            "변경 전 : 김일일"
                            "변경 후 : 김일이"
            4. 이 되도록 작성하고, PersonMain에서 person1의 이름을 setter를 통해 변경하시오.
            5. 이상의 코드를 작성했을 떄의 실행 예를 이하와 같습니다.
