...
//        System.out.println(smartPhone1);
        ...
        // 그래서 @AllArgsConstructor(access = AccessLevel.PRIVATE)로 수정해주면 11 번 라인이 오류가 발생합니다.

        SmartPhone phone1 = factory1.produceSmartPhone();
        SmartPhone phone2 = factory1.produceSmartPhone();
        SmartPhone phone3 = factory1.produceSmartPhone();
        SmartPhone phone4 = factory1.produceSmartPhone();
...
/*
    ...
    호출했는가와는 상관없이
    creatSerialNumber() 메서드를 호출한 결과가 단일한 Samsung 객체에서
