...
public class Main {
    public static void main(String[] args) {
        ...
        */
        ...
        scoreKorean = 100;          // 재대입할 떄는 자료형을 명시하지 않는다.
        ...
        System.out.println(name1 + name2 + name3); // 결과값 : 147432
        // 근데 74 라인의 경우에 변수 자료형이 char인데 문자가 여러 개 나오는 바람에 결과값이
        // 의도한대로 나오지 않음.
        ...
        /*
            ...
            즉
            작은따옴표('')는 '문자'를 표기하기 위한 기호
            큰따옴표("")는 "문자열"를 표기하기 위한 기호라고 알아두면 되겠습니다.

            그리고, sout()의 ()내부에서 가장 먼저 나온 데이터의 자료형을 따라간다는 정도
            확인할 수 있습니다.

            현재 학습한 부분 : boolean / char / String
                참고 : int - integer의 축약어로 "정수"를 의마함.

            과제 : name1, name2, name3에 여러분의 이름을 한글자씩 각각 대입하여
            ctrl + f10dmf 눌렀을 경우에
            김일이
            라고 출력될 수 있도록 작성하시오.
            그리고 한 줄 더 추가하시오.
        ...
        */
        ...
        System.out.println();           // println은 끝나고 개행됩니다.
        ...
        int width1 = 100;
        int width2 = 200;
        System.out.println(width1 + width2);    // 숫자 자료형 연산이 가능합니다.
        String width3 = "100";
        String width4 = "200";
