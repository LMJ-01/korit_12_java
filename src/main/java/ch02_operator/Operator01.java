...
/*
    ...
    Pascal case -> 첫 번쨰 문자가 대문자고 나머지는 소문자로 가다가 두 번째 단어의
        첫 번쨰 문자는 대문자다
...
public class Operator01 {
    public static void main(String[] args) {
        ...
        System.out.println(j);          // 그럼 얘는 바뀔 일이 없으니깐 12
        System.out.println(j--);        // 변수명-- : 코드를 실행시킨 후에 j에 1을 감함 / 그래서 12
        System.out.println(j);          // 그러면 얘는 11이겠네요.
        System.out.println(--j);        // --변수명 : 코드를 실행시키기 전에 j에서 1을 감함 / 10이겠네요
        ...
        System.out.println("내년에는 " + (age + 1) + "살이 됩니다.");
        // 이상의 경우에서 79 번 라인은 왜 원하는 결과값이 나오지 않는지 설명하시오. 라고 했을 때 가능한가 79 번 라인 첫번쨰 문자형을 따르기 때문에 문자열로 출력이 되어 20 + 1 = 201로 출력이된다.
