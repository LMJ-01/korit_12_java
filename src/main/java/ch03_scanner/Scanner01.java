...
//        System.out.println(name);
        /*
            ...
            현재까지의 상황에서
            Scanner scanner = new Scanner(System.in);
            이란 것을 쓰니깐 콘솔에 데이터를 입력해서 변수에 저장할 수 있고
            그 변수(name)dmf println하는 것이 가능하다 정도로 아는 것으로
            충분합니다.
            ...
            2. next  (Int / Double / Boolean, ... etc) vs. nextLine
                ...
                -> 그래서 scanner.nextLine() 으로 사용했을 떄 어제 kim il로 띄어쓰기 했을 떄 저장이
                    가능했습니다.
...
//        System.out.println("이름 : " + name2);
        ...
        /*
            이상의 코드에서의 문제점은 52 번 라인이 실행됐을 떄 데이터를 입력 받지 않고
            그대로 넘어가서 53 번 라인과 54 번 라인이 실행된단는 점입니다.
            이상의 문제는 nextLine()에서 값을 입력하고 enter를 치게 되는데,
            그 경우 다음 nextLine()에서 enter키를 받아들여서 빈 값인 상태로 enter를
            쳤다고 알아 듣기 때문에 곧장 53 번 라인이 실행됐습니다.
